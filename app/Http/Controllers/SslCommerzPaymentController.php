...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data = array();
        $post_data['total_amount'] = $request->customer_total_ammount; # You cant not pay less than 10
        ...
        # OPTIONAL PARAMETERS
        $post_data['course_name'] = $request->customer_course_name;
        $post_data['batch_name'] = $request->customer_batch_name;
        $post_data['branch_name'] = $request->customer_branch_name;
        $post_data['mentor_name'] = $request->customer_mentor_name;
        ...
        $update_product = DB::table('orders')
            ...
            ->updateOrInsert([
                ...
                'batch_name' => $post_data['batch_name'],
                'branch_name' => $post_data['branch_name'],
                'mentor_name' => $post_data['mentor_name']
            ]);
