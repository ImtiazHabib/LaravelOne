                ...
                <table class="table table-striped table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <!-- Addmission going on -->
                        @if(  $bacth->batch_admission_status  == 1 )
                           <span class="badge badge-secondary">Active</span>
                        @elseif( $bacth->batch_admission_status  == 2)
                           <span class="badge badge-dark">InActive</span>
                        @endif
                      </td>
                      <td>
                        <!-- course name from course table start -->
                        {{ $batch->course->course_english_title }}

                        <!-- course name from course table end  -->

                      </td>
                      <td>
                        <!-- mentor name from mentor table start -->
                        {{ $batch->mentor->mentor_fullname }}
