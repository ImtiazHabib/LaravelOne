...
<html lang="en">
  <head>
    ...
    <!-- Owl Carousel CSS -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/assets/coursedetails/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/assets/coursedetails/css/owl.theme.default.min.css') }}">

    <!-- Font Awesome CDN -->
    <link rel="stylesheet" type="text/css" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">

    <!-- Theme Main CSS File -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/assets/coursedetails/css/style.css') }}">
  </head>
  ...
  <body>
          ...
          <div class="col-md-12">
             ...
             <nav class="navbar navbar-expand-lg navbar-light">
              ...
              <a class="navbar-brand" href="#">
                <img src="{{ asset('frontend/assets/coursedetails/img/logo.png') }}" class="logo">
              </a>
              <!-- Logo End -->
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">                  
                  ...
                  <li class="nav-item">
                    <a class="nav-link btn-header mobile-hidden" href="{{ route('frontend.checkout', $batch->batch_slug) }}">ভর্তি হোন</a>
                  </li>
      ...
      <div class="container landing-banner">
        <div class="row">
          ...
          <div class="col-md-7 col-sm-12 col-12">
            <img src="{{ asset('frontend/assets/coursedetails/img/banner-bg.png') }}" class="img-fluid">
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="ln-tab-panel" id="sticky">
              <!-- Tab Logo -->
              <img src="{{ asset('frontend/assets/coursedetails/img/logo.png') }}" class="tab-logo">
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="ln-course-details-video">
                  <!-- Video Thumbnail -->
                  <img src="{{ asset('frontend/assets/coursedetails/img/course-details-video.png') }}" class="img-fluid">
                  <!-- Hover Content -->
        ...
        <div class="row">
          <div class="col-md-8 offset-md-4">
            ...
            <div class="row">
              <!-- Left Side Images -->
              <div class="col-md-6">
                <img src="{{ asset('frontend/assets/coursedetails/img/women-wearing.png') }}" class="image-one">
                <img src="{{ asset('frontend/assets/coursedetails/img/women-wearing.png') }}" class="image-two">
                <img src="{{ asset('frontend/assets/coursedetails/img/women-wearing.png') }}" class="image-three">
              </div>
          ...
          <div class="col-md-8 offset-md-4">
            ...
            <div class="row">
              <div class="col-md-3 std-support-system-content">
                <img src="{{ asset('frontend/assets/coursedetails/img/support.png') }}" class="img-fluid std-support-system-img">
              </div>
          ...
          <div class="col-md-8 offset-md-4">
            ...
            <div class="row mt-35">
              <div class="col-md-3 std-working-at">
                <img src="{{ asset('frontend/assets/coursedetails/img/support.png') }}" class="img-fluid std-working-at-img">
              </div>
          ...
          <div class="col-md-8 offset-md-4">
            ...
            <div class="news-slider owl-carousel owl-theme">
              ...
              <div class="item">
                <div class="row">
                  <div class="col-md-11">
                    <img src="{{ asset('frontend/assets/coursedetails/img/Prothom-Alo.png') }}" class="newspaper-logo">
                    <div class="news-coverage-thumbnail">
                      <img src="{{ asset('frontend/assets/coursedetails/img/prothom-alo-news.png') }}" class="img-fluid">
              ...
              <div class="item">
                <div class="row">
                  <div class="col-md-11">
                    <img src="{{ asset('frontend/assets/coursedetails/img/jugantor.png') }}" class="newspaper-logo">
                    <div class="news-coverage-thumbnail">
                      <img src="{{ asset('frontend/assets/coursedetails/img/jugantor-news.png') }}" class="img-fluid">
                      <div class="news-coverage-thumbnail-hover">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="marketplace-badge">
                      <ul>
                        <li><img src="{{ asset('frontend/assets/coursedetails/img/Level-2-Fiverr-Badge.jpg') }}"></li>
                        <li><img src="{{ asset('frontend/assets/coursedetails/img/trs-badge.png') }}"></li>
                      </ul>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-md-8 offset-md-4">
            ...
            <div class="row mt-35">
              <div class="col-md-3 how-to-start-content">
                <img src="{{ asset('frontend/assets/coursedetails/img/support.png') }}" class="img-fluid how-to-start-img">
              </div>
    ...
    <!-- Plugin JavaScript -->
    <script src="{{ asset('frontend/assets/coursedetails/js/jquery.easing.min.js')  }}"></script>
    <!-- Owl Carousel JS -->
    <script src="{{ asset('frontend/assets/coursedetails/js/owl.carousel.min.js')  }}"></script>
    <!-- Landing Page JS File -->
    <script src="{{ asset('frontend/assets/coursedetails/js/main.js')  }}"></script>
  </body>
</html>